...
```
bash <(curl -Ls https://raw.githubusercontent.com/webilomain/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/webilomain/3x-ui/master/install.sh) v1.6.0
```
